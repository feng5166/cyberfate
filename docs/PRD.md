...
| **天牌** | ☀️ | 单张牌聚焦，一天一张指引，简洁有力 | 1 张 | 每日打卡、快速寻求灵感 |
| **月光** | 🌙 | 柔和内省风格，关注潜意识与内在感受，解读语气更温柔 | 3 张 | 情感困惑、内心探索、睡前思考 |
| **镜像** | ✧ | 深度反思模式，从多角度透视同一问题，给出更犀利的分析 | 3-5 张 | 复杂决策、深度自我认知 |
...
|------|------|------|------|------|
| 抽牌数 | 3 | 1 | 3 | 3-5 |
| 牌阵 | 过去/现在/未来 | 单张无定位 | 身心灵/潜意识/指引 | 多角度自定义 |
| AI 语气 | 中性客观 | 简洁有力 | 温柔治愈 | 深度犀利 |
| 解读长度 | 标准(500字) | 短(200字) | 标准(500字) | 长(700字) |
| 适合用户 | 新手/首次 | 忙碌人群 | 情感型用户 | 进阶用户 |
| 默认推荐 | 是 | 否 | 否 | 否 |
