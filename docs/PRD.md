...
| 属性 | 值 |
|------|-----|
| 容器 | background #FFFFFF |
| 边框 | 1px solid #E5E7EB |
| 圆角 | rounded-2xl (16px) |
| 内边距 | p-6~p-8 (24-32px) |
| Hover 效果 | transform translateY(-4px) + shadow-lg box-shadow |
...
| 形状 | **圆形 (circle)** |
| 尺寸 | 48-56px 直径 |
| 背景 | #F3F4F6 或 #F9FAFB（浅灰/米白） |
| 图标尺寸 | 22-26px |
| 图标颜色 | #374151（深灰）或按功能用主题色 |
