...
- [x] **AI 模型**：Claude 3.5 Sonnet (Vercel AI SDK)
- [x] **部署平台**：Vercel
- [x] **域名**：使用 Vercel 自动分配的域名

### 8.2 产品细节 ✅

- [x] **时辰输入**：使用 12 时辰选择（子时~亥时 + "不知道"）
- [x] **农历输入**：MVP 不支持，V2 迭代
- [x] **出生地点**：MVP 不做真太阳时计算，不需要地点输入
