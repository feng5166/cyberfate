...
export function Header({
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 ${isHomePage ? 'bg-white/95 backdrop-blur-sm' : 'bg-white/90 backdrop-blur-md border-b border-brand-border-light'}`}>
