    ...
    <>
      <div className="flex items-center gap-2 overflow-x-auto pb-1 -mx-1 px-1">
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isActive
                  ? 'bg-brand-accent-soft text-brand-accent border border-brand-accent'
                  : 'bg-white text-[#1C1A16] border border-[#1C1A16]/8 hover:border-[#1C1A16]/30'
                }
              `}
            >
              {label}
        ...
        <button
          ...
          aria-label="选择日期"
          className="flex-shrink-0 w-11 h-11 rounded-full bg-brand-accent-soft text-brand-accent border border-brand-accent/30 hover:border-brand-accent transition-all flex items-center justify-center"
        >
