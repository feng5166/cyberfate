    ...
    <div className="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-2xl p-5 md:p-6 border border-yellow-200">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          placeholder="今天适合搬家吗？"
          disabled={loading}
          className="flex-1 bg-white rounded-xl px-4 py-3 text-sm text-[#1C1A16] border border-[#E8E4DD] focus:border-[#1C1A16] focus:outline-none transition-colors placeholder:text-[#1C1A16]/30 disabled:opacity-50"
        />
        <button
          type="submit"
