...
const STATIC_TAB_CONTENT: Record<'overview' | 'sihua', { title: string; content: string }> = {
  overview: {
    title: '命盘总览',
    content: `【格局评价】紫府同宫 · 上格贵命 ★★★★☆

此命盘紫微天府同宫于命宫（庚辰），为"紫府同宫"上格，格局清正高贵，属命理中难得的贵格之一。紫微为帝星，天府为财库星，二星同宫坐命，主一生有领袖气度与丰厚资源。命主天生具有领导气质与组织才能，性格沉稳大气，处事有条不紊，凡事能谋定而后动，在同辈中常为中心人物。

【性格特质】
命主为人大方慷慨，待人接物温和有礼，外表平和而内心坚毅。紫微赋予高远志向与强烈自尊，天府带来稳重与安全感。文昌旺度同会命宫，使命主口才出众、思维敏捷，在表达与协调方面有天赋。左辅庙度入命，主处事有人帮衬，遇事不缺助力。然而，紫府同宫者也容易"眼高于顶"，需学会适度放下身段，倾听他人意见，才能走得更远。

【事业分析】
文昌旺度、左辅庙度同会命宫，主聪慧好学、口才出众、得贵人相助，学业事业均有所成。文昌星助力文笔与表达，适合从事需要沟通协调的职业；左辅星则带来忠诚可靠的合作伙伴，事业上不乏助力。官禄宫（戊子）七杀独坐旺地，事业心强烈，执行力出色，适合开创性工作、技术领域或管理岗位。七杀旺地主开拓进取，虽压力较大但成就感强。

【财运分析】
财帛宫（甲申）贪狼旺度坐守，右弼天钺同会，求财途径多元，善于把握商机，中年后财运明显转旺。贪狼星在财帛主善于社交求财，配合右弼天钺两颗贵人星，往往能通过人脉关系拓展财源。正财稳定且偏财运也不弱，但须注意理财规划，防止"财来财去"。

【健康提醒】
疾厄宫（乙酉）天同巨门同度、擎羊同宫，中年后需格外注意消化系统与精神压力的调节。巨门主口舌，同时影响咽喉、肠胃健康。建议保持规律作息，坚持运动，学会情绪管理。

【人生建议】
迁移宫（丙戌）廉贞平度会火星地空，出外发展需谨慎，不宜频繁变动工作地点。整体格局属中上之命，一生有贵气扶持，事业可成，财运不缺。宜在30-50岁之间把握事业黄金期，积极布局；50岁后宜守成为主，享受成果。人际关系上需注意"宁可多听少说"，化解巨门化忌的负面影响。`,
  },
  sihua: {
    title: '人生四化飞星',
    content: `【化禄 — 贪狼化禄在财帛宫】🟢 大吉
贪狼化禄飞入财帛宫，是四化中最为吉利的格局之一。主一生财路亨通，尤其在营销、艺术、交际、餐饮等领域求财顺利。贪狼本身为桃花星，化禄后人缘极佳，善于通过社交活动与人脉资源获取财富。中年后此星力量更强，财运将有质的飞跃。此化禄也主命主物质生活丰裕，享受品质生活的能力强。需注意：财来得快也需善于守财，避免过度消费与投机，建立稳健的理财习惯至关重要。

【化权 — 紫微化权在命宫】🔵 大吉
紫微帝星本就高贵，化权后更添权势与决断力。命主在人群中自然居于核心地位，领导力与控制欲都很强。事业上能独当一面，不惧挑战，善于把握全局。此化权与化禄同源于命宫年干，形成"禄权同源"的格局，主事业与财运双旺——这是紫微斗数中非常难得的组合，意味着命主既有赚钱的能力，又有掌控局面的手腕。但需防过度强势而影响人际关系，学会适时示弱与倾听，方能让领导力发挥到极致。在团队中应注重授权，而非事事亲力亲为。

【化科 — 天机化科在交友宫】🟣 中吉
天机为智慧星，化科后更显文雅与学识。飞入交友宫，表示命主在社交中多得学识渊博之人指点，朋友圈层次较高，多为文化界、学术界人士。天机化科也主学习能力极强，善于从各种渠道获取知识与信息，特别适合终身学习。化科的另一层含义是"名声"，落在交友宫意味着命主在社交圈中口碑极佳，受人尊重。建议多参加高端社交活动与学术交流，贵人往往出现在这些场合。不要忽视任何一个学习与社交的机会。

【化忌 — 巨门化忌在疾厄宫】🔴 需化解
巨门为暗曜，主口舌是非，化忌后负面力量加强。落在疾厄宫，健康方面需特别注意消化系统（胃肠）、口腔、咽喉等问题，也暗示容易因言语不当或口舌纷争引发精神压力。化忌并非不可化解——巨门化忌的核心在于"言语"与"心结"，学会表达方式的转化就是最好的化解之道。建议保持心态平和，说话谨慎，少与人争辩。定期体检尤为重要，尤其每年秋冬季应关注肠胃与呼吸系统。

【四化总评】
禄权入命财，科星助友，仅忌星落疾厄，属于上吉格局。四化评分：★★★★☆（4/5星）。事业与财运为人生主要优势，社交圈层高端且有品质。禄权同源更是锦上添花，使命主在事业与财富方面有着超越常人的优势。唯一需要关注的是健康维护——巨门化忌在疾厄宫提醒命主：身体是革命的本钱，保养好身体，方能享受事业与财运带来的丰盛成果。建议每年做一次全面体检，日常注重饮食规律与情绪管理。`,
  },
};
