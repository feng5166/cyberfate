 ...
 * 紫微斗数 Mock 数据（开发/展示用）
 */
export const MOCK_PALACES = [
  { name: '命宫', star: '紫微', brightness: 100, body: '命宫主星' },
  { name: '父母宫', star: '天机', brightness: 80, body: '父母宫主星' },
  ...
  { name: '子女宫', star: '廉贞', brightness: 65, body: '子女宫主星' },
  { name: '夫妻宫', star: '破军', brightness: 55, body: '夫妻宫主星' },
  { name: '兄弟宫', star: '文曲', brightness: 78, body: '兄弟宫主星' },
] as const;
