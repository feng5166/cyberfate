...
// 纯展示派生（selectBacktestYears / buildNarrative / BacktestPick）已迁到 ./lifeKlineView，
// 那里不引 lunar-javascript，供客户端安全引用；此处再导出一次，服务端既有引用无需改动。
export { selectBacktestYears, buildNarrative, type BacktestPick } from './lifeKlineView';
