...

{
  ...
  "career": "开头1-2行总述格局(命局官杀食伤怎么流通);然后三层展开:第一层「- 配置特点:」一句话说清命局能量流通路径;第二层「- 适合职业:」开头再用a.b.c.编号展开每条职业方向(每条含「[XX五行]主怎么怎么」命理根据+具体行业2-3个);第三层「关键提示:」内嵌禁忌(最忌XX——命理依据一句话);含大运影响;要求300-380字",
