...
## 输出格式与字数要求
{
  "dayMasterAnalysis": "日主强弱完整推导,含得令/得地/得生/得助逐项分析+综合格局判断+用神喜忌+同党/异党力量对比总结句,要求220-300字",
  ...
  "dayunAnalysis": "当前大运深度分析,必须包含:1大运天干与命局的交互(合化/冲克关系)2大运地支与命局的交互3当前流年与大运叠加效应4当前阶段具体行动建议(事业/财务/健康/心态四个方向)5下一步大运预告约80-100字,要求450-560字",
