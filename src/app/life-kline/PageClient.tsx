...
// 值导入一律走 lifeKlineView（纯展示派生，无 lunar 依赖）；lifeKline 只取类型。
// 直接从 lifeKline 值导入会把 lunar-javascript 整库（97KB gz，CJS 不可 tree-shake）拖进首屏。
import { buildNarrative, selectBacktestYears } from '@/lib/bazi/lifeKlineView';
import type {
  DimKey,
  LifeKlineResult,
  LifeKlineLevel,
