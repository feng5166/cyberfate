  ...
  return (
    <>
      ...
      <section aria-label="关于梅花易数" className="mx-auto max-w-3xl px-4 py-12 text-[#1C1A16]/60 text-sm leading-relaxed border-t border-[#1C1A16]/8 mt-8">
        ...
        <p className="mb-3">梅花易数相传为北宋大儒邵雍（邵康节）所创，是《周易》体系中以&ldquo;心易&rdquo;为核心的占卜方法。相传邵雍观梅花飞落而悟得起卦之法，故名梅花易数。它打破了传统起卦对工具的依赖，主张&ldquo;万物皆可起卦&rdquo;——时间、数字、声音、方位、外应皆可成卦，关键在于动念瞬间的诚意与直觉。</p>
        <p className="mb-3">梅花易数的解卦体系以&ldquo;体用&rdquo;关系为核心。起卦得到的本卦分为体卦与用卦：体为求测者自身，用为所测之事。通过体用之间的五行生克与卦象之间的互卦、变卦推演，结合三才结构（天人地）综合分析事物发展。整个体系以简驭繁，强调灵感与逻辑并重。</p>
