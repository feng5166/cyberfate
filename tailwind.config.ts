    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          // ===== 唯一强调色：墨黑（黑白极简，2026-07 由暖古铜橙改） =====
          // 全站主 CTA / 选中态 / 激活指示唯一用色。强调靠「墨色实心块 + 白字 / 加粗 / 边框」，不靠色相。
          accent: "#1C1A16",
          "accent-hover": "#3A352E",   // 墨色实心块 hover 提亮，保证可见反馈
          "accent-soft": "#EFEDEA",    // 图标底片 / 极浅强调块（中性浅灰）
          "accent-tint": "#F6F4F1",    // 选中行/段控激活底（中性）
        },
        // ===== 五行色（传统五色，数据可视化唯一语言）=====
